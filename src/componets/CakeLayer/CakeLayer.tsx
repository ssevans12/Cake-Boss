...
export function CakeLayer(props: {layer: Layer}) {
    ...
    return (
        <div>
            <div className="cakelayer" style={{width: props.layer.width * 30 + "px", height: props.layer.height * 20 + "px", backgroundColor: props.layer.color, marginLeft: "auto", marginRight: "auto"}}>
